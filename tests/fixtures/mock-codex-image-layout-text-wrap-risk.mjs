...
writeFileSync(
  args[outputIndex + 1],
  JSON.stringify({
    summary: "문구는 인식했지만 제목 텍스트 박스를 너무 좁게 만들었습니다.",
    ...
    treeJson: JSON.stringify({
      helper: "screen",
      name: "Text wrap risk screen",
      width: 390,
      height: 844,
      layout: "none",
      children: [
        { helper: "text", name: "Title", characters: "생활통장", x: 24, y: 96, width: 28, height: 28 },
        { helper: "text", name: "Balance", characters: "케이뱅크 100", x: 24, y: 128, width: 100, height: 20 },
        { helper: "text", name: "Event row", characters: "이벤트 쿠폰 적금 알아보기", x: 56, y: 294, width: 200, height: 20 },
        { helper: "status-chip", name: "Disconnect", label: "내 자산 연결 해제", x: 24, y: 524, width: 342, height: 44 }
      ]
    })
  }),
  "utf8"
