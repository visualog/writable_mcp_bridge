...
writeFileSync(
  ...
  JSON.stringify({
    ...
    treeJson: JSON.stringify({
      helper: "screen",
      name: "Overlap regression screen",
      width: 390,
      height: 844,
      layout: "none",
      children: [
        { helper: "text", name: "Title", characters: "생활통장", x: 24, y: 96, width: 100, height: 28 },
        { helper: "text", name: "Balance", characters: "케이뱅크 100", x: 28, y: 102, width: 100, height: 20 },
        { helper: "text", name: "Bad overlapping title copy", characters: "생활통장", x: 30, y: 108, width: 100, height: 28 },
        { helper: "text", name: "Bad overlapping balance copy", characters: "케이뱅크 100", x: 34, y: 112, width: 100, height: 20 },
