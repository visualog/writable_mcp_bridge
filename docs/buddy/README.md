...
이 문서는 Buddy 관련 분석의 단일 진입점입니다.

현재 상태:
- 기존 dated 문서와 외부 메모는 보존합니다.
- 새 구조에서는 역할별 문서만 읽어도 핵심을 파악할 수 있게 정리합니다.
- 목적은 Buddy를 복제하는 것이 아니라, xbridge에 필요한 엔진과 UX 인사이트를 분리해 적용하는 것입니다.

읽는 순서:
1. [01-observations.md](./01-observations.md)
