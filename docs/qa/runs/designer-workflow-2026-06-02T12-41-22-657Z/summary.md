...
- cases: 34 total, 29 pass, 1 skip, 4 fail
- transport: healthy
- commandReadiness: ready
- writeReadiness: ready
- pending: 0 commands, 0 results
- recentFailedTotal: 0
- beforeCapture: /Users/im_018/Documents/GitHub/Project/figma_skills/xbridge/docs/qa/runs/designer-workflow-2026-06-02T12-41-22-657Z/captures/before.png
- afterCapture: /Users/im_018/Documents/GitHub/Project/figma_skills/xbridge/docs/qa/runs/designer-workflow-2026-06-02T12-41-22-657Z/captures/after.png
...
| L15 | fail | action=apply_style invalid + manual_border_shadow; handling=스타일 id/key가 없으면 실패 근거를 유지하고, 사용자가 요청한 시각 효과는 명시 수동값 fallback으로 적용한다. |
...
| L27 | fail | action=locked fixture mutation blocked; handling=locked node는 allowLocked=true 같은 명시 허용 없이는 자동 수정하지 않고 skipped/blocked로 보고해야 한다. |
| L28 | fail | action=hidden fixture mutation blocked |
...
| L31 | fail | action=mask fixture mutation blocked; handling=mask node는 allowMask=true 같은 명시 허용 없이는 자동 수정하지 않고 skipped/blocked로 보고해야 한다. |
...
| L15 | Style | fail | action=apply_style invalid + manual_border_shadow; handling=스타일 id/key가 없으면 실패 근거를 유지하고, 사용자가 요청한 시각 효과는 명시 수동값 fallback으로 적용한다. |
...
| L27 | Safety | fail | action=locked fixture mutation blocked; handling=locked node는 allowLocked=true 같은 명시 허용 없이는 자동 수정하지 않고 skipped/blocked로 보고해야 한다. |
| L28 | Hidden Safety | fail | action=hidden fixture mutation blocked |
...
| L31 | Mask Safety | fail | action=mask fixture mutation blocked; handling=mask node는 allowMask=true 같은 명시 허용 없이는 자동 수정하지 않고 skipped/blocked로 보고해야 한다. |
